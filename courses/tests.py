...
class CourseTest(TestCase):
    ...
    def setUpTestData(cls):
        ### create test database by this function to create courses
        ...
        """ ### lorem ipsum for overview of course object
        for i in range(5):
    ...
    def test_course_page(self):
        ### this function check the course list page that is loaded or not
        c = Client()
    ...
    def test_details_course_page(self):
        ### this test check course details that i can get all information about a course from database correct or not
        c = Client()
